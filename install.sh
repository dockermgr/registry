...
# @File          : registry
# @Description   : registry docker container installer
# @TODO          :
# @Other         :
# @Resource      :
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# Begin installer
APPNAME="registry"
DOCKER_HUB_URL="registry/registry"
REGISTRY_SERVER_PORT="${REGISTRY_SERVER_PORT:-5000}"
REGISTRY_SERVER_HOST="${REGISTRY_SERVER_HOST:-$(hostname -f 2>/dev/null)}"
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/$APPNAME"
REPO_BRANCH="${GIT_REPO_BRANCH:-main}"
REGISTRY_SERVER_TIMEZONE="${TZ:-${TIMEZONE:-America/New_York}}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
if docker ps -a | grep -qs "$APPNAME"; then
  printf_blue "Service is available at: http://$REGISTRY_SERVER_HOST:$REGISTRY_SERVER_PORT"
else
  false
fi
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
